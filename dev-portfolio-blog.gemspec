...
Gem::Specification.new do |spec|
  ...
  spec.version       = "0.1.8"
  spec.authors       = ["Syafiq Hadzir"]
  spec.email         = ["syafiq@hadzir.com"]
  spec.summary       = "Professional research portfolio and blog"
  spec.homepage      = "https://github.com/syafiqhadzir/research"
  spec.license       = "MIT"
